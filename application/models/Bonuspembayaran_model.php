...
class Bonuspembayaran_model extends CI_Model
{

    public $table = 'bonuspembayaran';
    public $id = 'ID';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('ID', $q);
		$this->db->or_like('idPembayaran', $q);
		$this->db->or_like('idBuruh', $q);
		$this->db->or_like('Persentase', $q);
		$this->db->or_like('TotalPembayaran', $q);
		$this->db->from($this->table);
